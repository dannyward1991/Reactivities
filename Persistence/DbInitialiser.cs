    ...
    public static async Task SeedData(AppDbContext context)
    {
        ...
        var activities = new List<Activity>
        {
            ...
            new() {
                ...
                Date = DateTime.Now.AddMonths(1),
                Desc = "Activity 1 month in future",
                Category = "culture",
                City = "London",
            ...
            new() {
                ...
                Date = DateTime.Now.AddMonths(2),
                Desc = "Activity 2 months in future",
                Category = "music",
                City = "London",
                Venue = "The O2",
            ...
            new()
            {
                ...
                Desc = "Activity 3 months in future",
                Category = "drinks",
                City = "London",
                Venue = "The Mayflower",
                Latitude = 51.501778,
            ...
            new()
            {
                ...
                Desc = "Activity 4 months in future",
                Category = "drinks",
                City = "London",
            ...
            new()
            {
                ...
                Desc = "Activity 5 months in future",
                Category = "culture",
                City = "London",
            ...
            new()
            {
                ...
                Desc = "Activity 6 months in future",
                Category = "music",
                City = "London",
            ...
            new()
            {
                ...
                Desc = "Activity 8 months in future",
                Category = "film",
                City = "London",
                Venue = "River Thames, England, United Kingdom",
                Latitude = 51.5575525,
